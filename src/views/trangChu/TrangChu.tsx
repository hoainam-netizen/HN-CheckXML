          ...
          <footer className="border-t border-slate-200 py-8 mt-12 bg-white/50 backdrop-blur-sm rounded-t-3xl">
            <div className="flex flex-col items-center gap-4">
              ...
              <button
                ...
                className="group flex items-center gap-2 text-[#3F8A3E] text-xs font-black uppercase tracking-widest hover:text-[#3F8A3E] transition-all"
              >
                <Search size={14} className="group-hover:scale-125 transition-transform" />
                Tra cứu tính năng hệ thống
              </button>
            </div>
          </footer>
